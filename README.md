...
OneClip 是一款专为 macOS 打造的**专业级剪贴板管理工具**。采用 **100% SwiftUI** 原生技术，实现更顺滑的动画、更自然的系统融合与更低的资源占用。支持 macOS 12.0 及以上版本（M芯片/intel芯片）。
...
- **顶部灵动岛拖放架**：适配刘海屏的顶部拖放架，支持拖拽到顶部灵动岛，实现一键复制粘贴
- **更多功能**：等你来发现
...
> **视频展示**
> - B 站：https://space.bilibili.com/1407028951/lists/5012369?type=series   （待更新新版）
